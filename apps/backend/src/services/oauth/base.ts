...
import { OAuthProvider } from "../../db/schemas/index.ts";
import { createGoogleOAuthClient } from "./google.ts";
import { Cookies } from "../../types/index.ts";
import { RETURN_TO_COOKIE_KEY } from "../../constants/index.ts";
...
export class OAuthClient<T> {
  ...
  createAuthUrl(cookies: Pick<Cookies, "set">, returnTo?: string) {
